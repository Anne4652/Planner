...
builder.Services.AddDbContext<PlannerContext>(options => options.UseNpgsql(connectionString))
...
builder.Services.Configure<JwtAuthOptions>(authOption);
var authOptions = authOption.Get<JwtAuthOptions>();
